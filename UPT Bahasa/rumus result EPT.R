...
# Connect to Database
dta <- odbcDriverConnect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=C:/Users/ASUS/OneDrive - Universitas Terbuka/UPTBAHASA/Database Projects/New UPT Bahasa Database Projects/New UPTBAHASA - v21.accdb")
...
tbl_toefl <- sqlFetch(dta, "qry_EPT_All") %>% as_tibble()
